...
<img src="https://www.vectorlogo.zone/logos/wireshark/wireshark-ar21.svg" alt="wireshark" width="40"> |
<svg width="64" height="64" version="1" xmlns="http://www.w3.org/2000/svg"><circle cx="32" cy="32" r="27" fill="#ff7d55" style="paint-order:stroke markers fill"/><path d="M32.496 13v6.947l-8.48 8.553h8.48v7h7.9l-7.9 9.553V51" fill="none" stroke="#fdfdfd" stroke-width="3"/></svg>
<hr>
